if defined?(ChefSpec)
  ...
  def create_postgresql_extension(resource_name)
    ChefSpec::Matchers::ResourceMatcher.new(:postgresql_extension, :create, resource_name)
  end

  def drop_postgresql_extension(resource_name)
    ChefSpec::Matchers::ResourceMatcher.new(:postgresql_extension, :drop, resource_name)
  end
  ...
  def update_postgresql_user(resource_name)
    ChefSpec::Matchers::ResourceMatcher.new(:postgresql_user, :update, resource_name)
  end

  def drop_postgresql_user(resource_name)
    ChefSpec::Matchers::ResourceMatcher.new(:postgresql_user, :drop, resource_name)
  end
end
